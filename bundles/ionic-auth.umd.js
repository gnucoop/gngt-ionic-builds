(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/common/http'), require('@angular/core'), require('@angular/forms'), require('@gngt/core/auth'), require('@gngt/core/common'), require('@gngt/ionic/common'), require('@ionic/angular'), require('@ngx-translate/core'), require('rxjs'), require('rxjs/operators'), require('@ngrx/store')) :
    typeof define === 'function' && define.amd ? define('@gngt/ionic/auth', ['exports', '@angular/common', '@angular/common/http', '@angular/core', '@angular/forms', '@gngt/core/auth', '@gngt/core/common', '@gngt/ionic/common', '@ionic/angular', '@ngx-translate/core', 'rxjs', 'rxjs/operators', '@ngrx/store'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.gngt = global.gngt || {}, global.gngt.ionic = global.gngt.ionic || {}, global.gngt.ionic.auth = {}), global.ng.common, global.ng.common.http, global.ng.core, global.ng.forms, global.ng.core.auth, global.ng.core.common, global.ng.ionic.common, global.ionic.angular, global.ngx.translate.core, global.rxjs, global.rxjs.operators, global.ngrx.store));
}(this, (function (exports, common, http, core, forms, auth, common$1, common$2, angular, core$1, rxjs, operators, store) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AuthUserInteractionsService = /** @class */ (function (_super) {
        ...
        AuthUserInteractionsService.prototype.askLogoutConfirm = function () {
            var _this = this;
            var strings = ['Are you sure you want to logout?', 'Cancel', 'Ok'];
        ...
        AuthUserInteractionsService.prototype.showLoginError = function (error) {
            this._toast.create({ message: error, duration: 3000 }).then(function (t) { return t.present(); });
        };
    ...
    exports.ɵgc_gngt_src_ionic_auth_auth_a = AuthUserInteractionsService;
